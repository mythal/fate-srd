...
**高概念**是涵括角色重要核心的廣泛描述。你會用它簡短介紹角色，會和朋友如此談論他。
...
弗雷德決定，他想用一個較短的技能表來製作太空飛行的命運遊戲，這個技能表聚焦在動作詞。他確定了 9 項技能的表：戰鬥、知道、移動、感知、領航、隱匿、說話、擺弄和意志。他還喜歡以「鑽石」形狀而非金字塔來評定技能等級，因此他讓玩家對他們的起始技能評定如下：1 級出色（+4），2 級良好（+3），3 級尚可（+2），2 級普通（+1），1 級平庸（+0）。由於他的鑽石中間肥厚，他的 PC 會有很多重疊處和核心競爭力，同時在鑽石「點」的頂端仍然保有獨特性。
...
- **給予角色差不多相當於 +2 獎勵的好處**。譬如，當一個有技巧的演說家以**親善**創造優勢時，它得到免費援引。
