...
**特征**是描述你的角色是誰，或什麼對他重要的短語。它們可以關於角色的物理或心靈素質、歷史、信念、訓練、關係、甚至重要裝備。

關於特征，首要的是：**特征是真實的**。換句話說，你如何定義角色，在你們的故事裡面就是全然真實不欺的。如果你對角色寫下`預知靈能狙擊手`，他就是一名預知靈能狙擊手。你已經告訴大家，你的角色能預見未來，而且是步槍射擊高手。

你也會在遊戲中使用特征來改變故事。允許你用它獎勵骰子、建立關於世界的事實。最後，如果特征為你的角色帶來麻煩，你還可以獲得命運點——因此，要讓特征是多方面的，就該以雙面刃為特征的目標，既有利又不利於你。

要想瞭解更多關於特征的事，和了解怎樣才是好的特征，可以考慮閱讀〈[特征與命運點](aspects-and-fate-points)〉的章節。

**開始時，你要給角色五個特征**：一個核心概念、一個麻煩、一個關係，和兩個自由特征。從核心概念開始，然後前進。
...
好的關係特征必須引入或暗示衝突，或至少是能給關係能動力的失衡狀態。兩人可以不用一定是公開敵對，但還是不要什麼都盡善盡美。

若你希望，你可以等到所有人都差不多完成角色的時候再來寫關係特征。

### 自由特征

角色的最後兩個特征可以是所有你想要的——除了必須合乎設定，沒有其餘限制。選擇你認為能讓角色更有趣的、更好玩的或讓他們與世界更有關聯的。

## 技能

特征定義了角色是誰，而**技能**表示了他能做的事。每個技能都描述了一項廣泛活動，你的角色通過學習和實踐學會了它，或是天生就有此天賦。一個有盜竊的角色，在某程度上，有能力完成與樑上君子技藝有關的所有犯罪活動———偷竊、繞過保全、扒竊和撬鎖。
...
給你的角色名字與描述，並討論他與其他玩家角色的歷史。如果你還沒寫下關係特征，現在來寫。