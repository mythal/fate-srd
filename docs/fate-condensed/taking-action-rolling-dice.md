...
由創造優勢所創造（或發現）的形象，就如同其他形象。它定義了敘述環境，能允許、阻止或阻礙行動——例如，如果房間變得`一片漆黑`，你就無法閱讀咒語。它也可以被援引或驱使。此外，創造優勢可以給你在所創造形象上一個或多個免費援引。免費援引，顧名思義，你無需花費命運點就能援引該形象。你甚至可以讓盟友使用你創造的免費援引。
